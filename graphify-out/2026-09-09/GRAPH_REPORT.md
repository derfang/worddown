# Graph Report - worddown  (2026-09-09)

## Corpus Check
- 121 files · ~138,851 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1042 nodes · 1273 edges · 62 communities (47 shown, 9 thin omitted)
...
Cohesion: 0.04
Nodes (48): _audioPlayer, _audioSequenceId, build, _buildAntonymQuestion, _buildCompareQuestion, _buildContent, _buildExampleQuestion, _buildListeningQuestion (+40 more)
...
Cohesion: 0.05
Nodes (40): audioFocusMode, enableAntonymQuestion, enableCompareQuestion, enableEdgeTts, enableExampleQuestion, enableGoogleTts, enableMeaningQuestion, enableMisspellingQuestion (+32 more)
...
## Knowledge Gaps
- **651 isolated node(s):** `main`, `DefaultFirebaseOptions`, `web`, `android`, `windows` (+646 more)
...
- **Why does `ProgressService` connect `sync_service.dart` to `learning_session_screen.dart`, `progress_service.dart`, `review_screen.dart`?**
